...
export const INITIAL_POSTS: Post[] = [
  {
    ...
    authorIsAdult: false,
    contentType: "image",
    mediaUrl: "https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?w=600&auto=format&fit=crop&q=80",
  ...
  },
  {
    ...
    tags: ["deporte", "motivacion", "fitness", "gym"],
    category: "vlog",
    privacy: "public",
    allowComments: true,
    allowSharing: true,
  ...
  },
  {
    ...
    authorIsAdult: true,
    contentType: "image",
    mediaUrl: "https://images.unsplash.com/photo-1500485035595-cbe6f645feb1?w=600&auto=format&fit=crop&q=80",
    caption: "Sesión fotográfica de modelaje artístico veraniego en la playa. Contenido estético +18. #model #estilo #verano",
    tags: ["model", "estilo", "verano"],
    category: "vlog",
...
export const INITIAL_CHATS: Chat[] = [
  {
    ...
    user2Id: "user_alexis",
        messages: [
      {
        ...
        senderPic: "",
        senderAge: 16,
        content: "¡Hola Alexis! ¿Cómo va todo hoy?",
        type: "text",
      ...
      },
      {
        ...
        senderPic: "",
        senderAge: 14,
        content: "¡Hola Sofi! Todo bien por aquí, regando mis suculentas 🌵 ¿Y tú?",
        type: "text",
