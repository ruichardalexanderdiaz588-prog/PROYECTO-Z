    ...
    async function loadData() {
      ...
      try {
        const [
          ...
          getSupabase().from("posts").select("*").order("createdAt", { ascending: false }),
                            ...
                            <div className="space-y-2 text-xs">
                              {isSelf && (
                                <button 
                                  ...
                                  className="w-full mb-3 py-2 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-xl text-[10px] font-black uppercase tracking-widest text-slate-300 transition-all"
                                >
                                  Editar Perfil
                                </button>
                              )}
